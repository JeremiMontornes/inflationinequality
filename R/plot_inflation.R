...
#'
#' @description
#' `plot_time_series()` creates a line plot of inflation rates over time for selected categories.
#'
#' @details
#' The function performs the following operations:
#' 1. Selects the lowest and highest categories from the inflation data.
#' 2. Calculates the average inflation for each (year, month) pair to create a "Total" category.
#' 3. Combines the original data with the new "Total" category.
#' 4. Creates a line plot using ggplot2 with date on the x-axis and inflation rate on the y-axis.
#'
...
#'
#' @description
#' `plot_grouped_bar()` creates a grouped bar chart comparing inflation rates across different categories and countries for a specific year.
#'
#' @details
#' The function performs the following operations:
...
#' 3. Creates a grouped bar chart using ggplot2 with categories on the x-axis and average inflation on the y-axis, grouped by country.
#'
#' @param year The specific year for which to plot the data.
#' @param ... One or more objects of class `"inflation"` containing inflation data for different countries.
#'
...
#'
#' @description
#' `plot_contribution_gap()` creates a stacked bar chart showing the contribution of different COICOP categories to the inflation gap between the lowest and highest income categories over time.
#'
#' @details
#' The function performs the following operations:
...
#' 5. Creates a stacked bar chart with date on the x-axis and contribution gap on the y-axis, colored by COICOP category.
#' 6. Overlays a line representing the total gap between inflation rates of bottom and top quintiles.
#'
#' @param contributions An object of class "contributions" containing contribution data.
#'
#' @return A ggplot object representing the stacked bar chart of contribution gaps.
#'
#' @examples
...
#'
#' @export
plot_contribution_gap <- function(contributions) {
