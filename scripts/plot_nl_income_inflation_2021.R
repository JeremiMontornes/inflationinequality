...
inflation_nl <- calculate_inflation("NL", "income", start_year = 2021)

p <- plot_time_series(inflation_nl) +
  labs(
    title = "Netherlands inflation by income quintile",
...
out <- file.path("docs", "nl_income_inflation_2021.png")
